...
def training_data_generate():
    ...
    features_2016 = pd.read_hdf('hdf5/features.h5', 'features_2016')
    features_2017 = pd.read_hdf('hdf5/features.h5', 'features_2017')

    # Join the training data with the property table
    train_2016 = train_2016.merge(how='left', right=features_2016, on='parcelid')
    train_2017 = train_2017.merge(how='left', right=features_2017, on='parcelid')
